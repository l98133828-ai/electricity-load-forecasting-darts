...
plt.title("Electricity Load Forecast with NaiveSeasonal(K=24)")
plt.xlabel("Time")
plt.ylabel("Hourly Consumption")
plt.legend()
plt.savefig("outputs/electricity_baseline_forecast.png", dpi=300, bbox_inches="tight")
plt.show()