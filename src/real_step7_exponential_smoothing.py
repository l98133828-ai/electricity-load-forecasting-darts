...
print("ExponentialSmoothing(seasonal_periods=24)")
...
plt.title("Electricity Load Forecast with ExponentialSmoothing")
plt.xlabel("Time")
plt.ylabel("Hourly Consumption")
plt.legend()
plt.savefig("outputs/electricity_exponential_smoothing_forecast.png", dpi=300, bbox_inches="tight")
plt.show()